...
public class TestingCsvConfiguration {

    public static final String RELEASE = "Release";
    public static final String TESTER = "Tester";

    public static final String DEVELOPER_PRODUCTIVITY = "Developer Productivity";
    ...
    public static final String EXPECTED_SEVERE_FIXES = "Expected Severe Fixes";
    ...
    public static final String TESTER_REPORTED_ISSUES= "Tester Reported Issues";
}
