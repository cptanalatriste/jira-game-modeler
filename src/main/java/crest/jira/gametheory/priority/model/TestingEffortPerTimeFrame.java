...
public class TestingEffortPerTimeFrame {
     ...
     *
     * @param timeFrame             Release.
     * @param reportersPerBoard     Reporters for the current board.
     * @param totalIssuesPerRelease Issues reported prior to the release.
     */
    ...
    private void storeUserMetrics(ExtendedUser extendedUser, TesterBehaviour testerPlay) {
        extendedUser.registerParticipation(testerPlay.getTestReport().getIssuesReported());
